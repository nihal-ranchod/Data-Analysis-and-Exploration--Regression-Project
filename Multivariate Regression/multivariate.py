...
plt.title('Residual Plot for Iteration 1 (Training Data)')

plt.subplot(1, 2, 2)
plt.scatter(y_iter1_test_pred, residuals_iter1_test, color='red')
plt.xlabel('Predicted Values')
plt.ylabel('Residuals')
plt.title('Residual Plot for Iteration 1 (Test Data)')
plt.show()
...
plt.xlabel('Predicted Values')
plt.ylabel('Residuals')
plt.title('Residual Plot for Iteration 2 (Training Data)')

plt.subplot(1, 2, 2)
plt.scatter(y_iter2_test_pred, residuals_iter2_test, color='red')
plt.xlabel('Predicted Values')
plt.ylabel('Residuals')
plt.title('Residual Plot for Iteration 2 (Test Data)')
plt.show()
...
plt.xlabel('Predicted Values')
plt.ylabel('Residuals')
plt.title('Residual Plot for Iteration 3 (Training Data)')

plt.subplot(1, 2, 2)
plt.scatter(y_iter3_test_pred, residuals_iter3_test, color='red')
plt.xlabel('Predicted Values')
plt.ylabel('Residuals')
plt.title('Residual Plot for Iteration 3 (Test Data)')
plt.show()
